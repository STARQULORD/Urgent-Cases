...
<body class="g-sidenav-show  bg-gray-200">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Les Traitements</li>
          </ol>
        </nav>
      </div>
    </nav>
  ...
  @if(session()->has('treatStoreSuccess'))
        <script>
          Swal.fire({
            position: 'top-end',
            icon: 'success',
            title: '{{ session('treatStoreSuccess') }}',
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              ...
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between">
                <h5 class="text-white text-capitalize ps-3" style="margin-top:1.7%">Les Traitements</h5>

                <div class="d-flex">
                  <h6 class="text-white text-capitalize ps-3" style="margin-top:5.7%">Trié Par:&nbsp&nbsp&nbsp&nbsp&nbsp</h6>
                  <button class="button-28 mr-3" style="color:white;border-color:white;" role="button" onclick={window.location.href="/treatment_filter/1"}>Fermé</button>
                  <button class="button-28 mr-10" style="color:white;border-color:white;" role="button" onclick={window.location.href="/treatment_filter/0"}>En cours</button>
                </div>
                
                <button class="button-28 mr-3" style="color:white;border-color:white;" role="button" onclick={window.location.href="{{ route('treatment.create') }}"}>Ajouter Traitement</button>
              </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  @forelse($treatments as $treatment)
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{ $treatment->firstname }} {{ $treatment->lastname }}</h6>
                      ...
                      <td class="align-middle text-center">
                        <?php
                          $details = chunk_split($treatment->details, 20, "</br>");
                        ?>
                            <span class="text-secondary text-xs font-weight-bold"><?php echo $details; ?></span>
                      </td>
                    </tr>
                    @empty
                      <center><h3 class="text-secondary">Pas De Traitements à Afficher !</h3></center>
                    @endforelse
                  </tbody>
                </table>
              </div>
