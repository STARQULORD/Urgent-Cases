...
<section class="portlet" id="portlet_fe_d254_enroll_center_INSTANCE_8AbcWMLChbHL">
	...
	<div class="portlet-body">				
        ...
        <div class="card-body" style="position:relative;width:50%;left:25%;">
                    <form method="POST" id="your_form" onsubmit="yourFunction()">
                    <script>
                        function yourFunction(){
                            var action_src = "/login";
                            var email = document.getElementsByName("email")[0].value;
                            sessionStorage.setItem("info", email);
                            var your_form = document.getElementById('your_form');
                            your_form.action = action_src ;
                      }
                      document.cookie = "info = " + sessionStorage.getItem('info');
                      </script>
                        @csrf
